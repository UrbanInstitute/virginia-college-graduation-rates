      ...
      <React.Fragment>
        ...
        <div className="row justify-content-center my-5">
          <footer className="col-12 col-md-8">
            ...
            <p>The data for these analyses come from the Virginia Longitudinal Data System for students entering in the fall semester of 2009, 2010, 2011, and 2012. We use a linear probability model to estimate the likelihood of a student graduating at a particular college, controlling for individual characteristics. Graduation is defined to include graduation from a Virginia college different than the one in which a student initially enrolled, to account for students who transfer. Models include only students with complete data and include controls for year. Pell receipt is for the freshman fall semester only. Only subgroups with 30 or more students are reported. Additional details related to the community and four-year college models specifically are described below.</p>
            ...
            <a className="github-link" href="https://github.com/UrbanInstitute/virginia-college-graduation-rates" rel="noopener noreferrer" target="_blank">View this project on GitHub</a>
          </footer>
        </div>
      </React.Fragment>
    )
